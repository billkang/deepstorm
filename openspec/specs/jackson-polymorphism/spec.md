# jackson-polymorphism Specification

## Purpose
Jackson `@JsonTypeInfo` / `@JsonSubTypes` 多态序列化编码规范，定义 Spring Boot 后端中基于 discriminator 的多态类型分发约定，以及前后端 discriminator value 严格一致的协作规范。
